...
public class LangDetectTest {
	...
	@Before
	public void init() {
		testRunner = TestRunners.newTestRunner(LangDetectProcessor.class);
	}
	...
	public void testProcessor() {
		...
		List<MockFlowFile> successFiles = testRunner.getFlowFilesForRelationship(LangDetectProcessor.REL_SUCCESS);
	...
	@Test
	public void testProcessorSpanish() {
		
		testRunner.setProperty(EXTRA_RESOURCE, "/Volumes/seagate/models"); 
		
		try {
			testRunner.enqueue(new FileInputStream(new File("src/test/resources/spanish.txt")));
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		}
